    ...
    <main>
      <div class="flex items-center justify-end gap-3 px-36 pt-10">
        ...
        <button
          ...
          class="rounded bg-blue-200 px-4 py-2 text-sm font-semibold text-blue-800"
        >
          + Add Product
        </button>
        <button
          class="rounded bg-blue-700 px-4 py-2 text-sm font-semibold text-blue-100"
      ...
      <div class="my-4 flex px-36">
        <button class="border-b-2 border-blue-500 py-1 font-medium text-blue-600">
          Category 1
        </button>
            ...
            <div class="p-3">
              ...
              <div class="mt-5 flex justify-center">
                <button
                  ...
                  class="w-full rounded bg-blue-500 px-4 py-2 text-sm text-white sm:max-w-32"
                >
                  + Add to Cart
                </button>
              </div>
